<?php
	...
	// the maximum length (both width and height) for any photowall image uploaded to isc -- any images larger than this will be sized down for storage, any settings in the control panel for image sizes will be capped to this
	define('ISC_PHOTOWALL_IMAGE_MAXLONGEDGE', 1280);

	define('ISC_PHOTOWALL_IMAGE_SIZE_ZOOM', 1);
	define('ISC_PHOTOWALL_IMAGE_SIZE_STANDARD', 2);
	define('ISC_PHOTOWALL_IMAGE_SIZE_THUMBNAIL', 3);
	define('ISC_PHOTOWALL_IMAGE_SIZE_TINY', 4);

	define('ISC_PHOTOWALL_IMAGE_DIMENSIONS_WIDTH', 0);
	define('ISC_PHOTOWALL_IMAGE_DIMENSIONS_HEIGHT', 1);

	// The minimum dimension to enable image zoom.
	define('ISC_PHOTOWALL_IMAGE_MIN_ZOOM_WIDTH', 300);
	define('ISC_PHOTOWALL_IMAGE_MIN_ZOOM_HEIGHT', 300);

	define('ISC_PHOTOWALL_DEFAULT_IMAGE_SIZE_ZOOM', 1280);
	define('ISC_PHOTOWALL_DEFAULT_IMAGE_SIZE_STANDARD', 500);
	define('ISC_PHOTOWALL_DEFAULT_IMAGE_SIZE_THUMBNAIL', 250);
	define('ISC_PHOTOWALL_DEFAULT_IMAGE_SIZE_TINY', 30);
	...
	header("Content-Type: text/html; charset=" . GetConfig('CharacterSet').";Connection: keep-alive");
