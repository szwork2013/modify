<?php
	...
	// Last Updated: 20th Jun 2013 @ 4:53 PM

	$GLOBALS['ISC_CFG']["isSetup"] = true;
	$GLOBALS['ISC_CFG']["Language"] = 'en';
	$GLOBALS['ISC_CFG']["AllowPurchasing"] = 1;
	$GLOBALS['ISC_CFG']["serverStamp"] = 'ISCEAIAAAAAAwCIE66Ih1XIkmopK5+FxUvP+dY';
	...
	$GLOBALS['ISC_CFG']["dbUser"] = 'modify';
	$GLOBALS['ISC_CFG']["dbPass"] = 'Oski2010!';
	$GLOBALS['ISC_CFG']["dbDatabase"] = 'modify_store';
	$GLOBALS['ISC_CFG']["tablePrefix"] = 'isc_';
	$GLOBALS['ISC_CFG']["StoreName"] = 'Modify Watches';
	$GLOBALS['ISC_CFG']["StoreAddress"] = '148 Townsend Street
San Francisco, CA  94107';
	...
	$GLOBALS['ISC_CFG']["MetaDesc"] = 'Modify Watches are super-dope, interchangeable watches. You can mix-and-match faces and straps to create the "Mod" that allows you to make your statement, whether (quiet) or LOUD.';
	$GLOBALS['ISC_CFG']["DownloadDirectory"] = 'product_downloads';
	$GLOBALS['ISC_CFG']["ImageDirectory"] = 'product_images';
	$GLOBALS['ISC_CFG']["template"] = 'Modify';
	...
	$GLOBALS['ISC_CFG']["InstallDate"] = 1309900429;
	...
	$GLOBALS['ISC_CFG']["CategoryListDepth"] = 3;
	...
	$GLOBALS['ISC_CFG']["AdminEmail"] = 'aaron@modifywatches.com';
	$GLOBALS['ISC_CFG']["OrderEmail"] = 'aaron@modifywatches.com';
	...
	// Shipping Settings
	$GLOBALS['ISC_CFG']["CompanyName"] = 'Modify Watches';
	$GLOBALS['ISC_CFG']["CompanyAddress"] = '148 Townsend Street';
	$GLOBALS['ISC_CFG']["CompanyCity"] = 'San Francisco';
	$GLOBALS['ISC_CFG']["CompanyCountry"] = 'United States';
	$GLOBALS['ISC_CFG']["CompanyState"] = 'California';
	$GLOBALS['ISC_CFG']["CompanyZip"] = '94107';

	// Checkout Settings
	$GLOBALS['ISC_CFG']["CheckoutMethods"] = 'checkout_braintree,checkout_googlecheckout,checkout_paypalexpress';
	$GLOBALS['ISC_CFG']['CheckoutType'] = 'multipage';
	...
	$GLOBALS['ISC_CFG']["EmailIntegrationNewsletterSendWelcome"] = 0;
	...
	$GLOBALS['ISC_CFG']['StoreTimeZone'] = '-8';
	$GLOBALS['ISC_CFG']['StoreDSTCorrection'] = 1;
	...
	$GLOBALS['ISC_CFG']["GoogleMapsAPIKey"] = 'AIzaSyB1DBLPkR0AOTstN-ZwnpKWaqlplnKNDE4';
	...
	$GLOBALS['ISC_CFG']["AnalyticsMethods"] = 'analytics_googleanalytics,analytics_shareasale';
  ...
  2 => 'Store Credit',
	...
	$GLOBALS['ISC_CFG']['OrderStatusNotifications'] = '11,9,8,3,10,2,5,4';

	$GLOBALS['ISC_CFG']['AddonModules'] = 'addon_permissioncheck,addon_photowall,addon_verifyfiles';
	...
	$GLOBALS['ISC_CFG']["EncryptionToken"] = 'f1a943ae53b01e233eda31d8a58dfd90';
	...
	$GLOBALS['ISC_CFG']['AffiliateConversionTrackingCode'] = '<!-- Begin Curebit integration code -->
<script type="text/javascript">
  //<![CDATA[
        (function(){function async_load(){var s=document.createElement(\'script\');s.type=\'text/javascript\';s.async=true; s.src=\'https://d2vzmlm7xciaqk.cloudfront.net/asset-v8a6ef8f/javascripts/api/all-0.4.js\'; var x=document.getElementsByTagName(\'script\')[0];x.parentNode.insertBefore(s,x)} if(window.attachEvent)window.attachEvent(\'onload\',async_load);else window.addEventListener(\'load\',async_load,false)})();
    
    var _curebitq = _curebitq || [];
    _curebitq.push([\'init\', { site_id: \'modify-watches--2\' }]);  /* REQUIRED - Curebit Site ID */
...
<!-- End Curebit integration code -->  ';
	...
	// Accounting Settings
	$GLOBALS['ISC_CFG']['AccountingMethods'] = 'accounting_quickbooks';
	...
	$GLOBALS['ISC_CFG']['ShowAddToCartLink'] = 0;
  ...
  6 => 'storeComplete',
	...
	// Abandon Orders
	$GLOBALS['ISC_CFG']['AbandonOrderLifetime'] = '180';
	...
	$GLOBALS['ISC_CFG']['JSCacheToken'] = 25;
	...
	$GLOBALS['ISC_CFG']["StartingOrderNumber"] = 8292;
	...
	$GLOBALS['ISC_CFG']['CustomersAlsoViewedCount'] = 2;
	...
	$GLOBALS['ISC_CFG']['taxDefaultTaxDisplayCatalog'] = '1';
	$GLOBALS['ISC_CFG']['taxDefaultTaxDisplayProducts'] = '1';
	$GLOBALS['ISC_CFG']['taxDefaultTaxDisplayCart'] = '1';
	...
	$GLOBALS['ISC_CFG']['taxDefaultCountry'] = '226';
	$GLOBALS['ISC_CFG']['taxDefaultState'] = '12';
	$GLOBALS['ISC_CFG']['taxDefaultZipCode'] = '94709';
	$GLOBALS['ISC_CFG']['taxPendingChanges'] = NULL;
	...
	$GLOBALS['ISC_CFG']['enableMobileTemplate'] = false;
  ...
  3 => 'android',
	...
	$GLOBALS['ISC_CFG']['FacebookLikeButtonAdminIds'] = 'modifywatches';
