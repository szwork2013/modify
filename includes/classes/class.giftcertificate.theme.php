...
class ISC_GIFTCERTIFICATE_THEME {
	...
	public function generateGiftCertificateHTML($certificate)
	{
		...
		$GLOBALS['GiftCertificateSignoff'] = isc_html_escape($certificate['giftcertsignoff']);
		$GLOBALS['GiftCertificateGreeting'] = isc_html_escape($certificate['giftcertgreeting']);
