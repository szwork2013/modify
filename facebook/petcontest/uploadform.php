...
if (isset($_POST['Submit']) && $_POST['Submit'] == "Upload") {
	...
	if ($foto_upload->upload()) {
		...
		die("<link href=\"http://dev.modifywatches.com/store/templates/modify/Styles/blue.css?186\" media=\"all\" type=\"text/css\" rel=\"stylesheet\" /> <div class=\"uploadText\">Thanks!</div><div class=\"uploadBody\" stlye='font-size:16px;'>The file has been uploaded. It should appear on the voting page shortly!</div>");
	}
}
...
<title>Photo Upload</title>
	...
	<link href="http://dev.modifywatches.com/store/templates/modify/Styles/blue.css?186" media="all" type="text/css" rel="stylesheet" /> 
	<script type="text/javascript" src="http://dev.modifywatches.com/store/javascript/upload.js"></script>
    <script type="text/javascript" src="http://dev.modifywatches.com/store/javascript/jquery.js"></script>
    <script type="text/javascript"> 
        ...
        $(document).ready(function() { 
           $('#Submit').click(function() {
			  ...
			  $(".uploadBody").html("<img src='htp://dev.modifywatches.com/store/templates/modify/images/blue/sandbox/ajax-loader.gif' />"); 
		   });
        }); 
...
<div class="uploadForm">
    ...
    <div class="uploadBody">
    	<form action="http://dev.modifywatches.com/facebook/petcontest/uploadform.php" id="actualForm" method="post" enctype="multipart/form-data">
            ...
            <input type="image" src="http://dev.modifywatches.com/store/templates/modify/images/blue/uploadbutton.png" name="Submit" id="Submit" value="Upload" style="margin-top:5px;float:left;cursor:pointer;"/>
		</form>
         <p><?php echo $error; ?></p>
    </div>
