...
<body style="overflow: hidden">
  ...
  <div style="height:2600px; width:522px;">
  		<div style="width:522px;height:276px;background-image:url('images/contestinfohead.jpg');"></div>
        <div style="width:522px;height:2600px;background-image:url('images/background.jpg');background-repeat:repeat-y;">
        	<div style="width:475px;position:relative;left:22px;top:4px;">
            ...
            <div style="width:475px;position:relative;left:22px;top:4px;">
            	<div style="width:250px;height:372px;border: 3px #ebebeb;position:relative;top:5px;left:2px;float:left;">
            ...
            <div style="width:475px;position:relative;left:22px;top:4px;">
            	<div style="width:250px;height:336px;border: 3px #ebebeb;position:relative;top:5px;left:2px;float:left;">
            ...
            <div style="width:475px;position:relative;left:22px;top:4px;">
            	<div style="width:250px;height:377px;border: 3px #ebebeb;position:relative;top:5px;left:2px;float:left;">
            ...
            <div style="width:475px;position:relative;left:22px;top:4px;">
            	<div style="width:250px;height:190px;border: 3px #ebebeb;position:relative;top:5px;left:2px;float:left;">
                	<a href="photos/Farrah.jpg"><img src="photos/Farrah.jpg" width="250px" style="border:none;" /></a>
                </div>
                <div style="float:left;width:179px;height:132px;background-image:url('images/voteboxborder.gif');position:relative;top:35px;left:20px;">
                	<div style="position:relative;left:10px;top:15px;">
                    	<span style="font-size: 15px; font-family: Tahoma, Geneva, sans-serif; color: #465761;">Submitted By:</span><br />
                        <span style="font-size: 22px; font-family: Tahoma, Geneva, sans-serif; color: #465761;">Farrah Chinderle</span><br /><br />
                        <div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#appId=159118097489884&amp;xfbml=1"></script><fb:like href="http://modifywatches.com/facebook/photocontest/photos/Farrah.jpg" send="true" layout="button_count" width="160" show_faces="false" font=""></fb:like>
                        <span style="font-size: 10px; font-family: Tahoma, Geneva, sans-serif; color: #465761;">(Click Like to Vote)</span>
                     </div>
                </div>
            </div>
            <div style="width:480px;position:relative;left:22px;top:15px;float:left;">
                <span style="font-size: 16px; font-weight:200; font-family: Tahoma, Geneva, sans-serif; color: #465761;">Voting Ends on Monday, June 27th at 12pm! Get your votes in. :)</span>
            </div>
        </div>
        <div style="width:522px;height:57px;background-image:url('images/sharebottom.jpg');position:relative;top:-50px;">
        	<div style="position:relative;left:255px;top:15px;">
            	<script>
					function fbs_click() {
						u='http://www.modifywatches.com/facebook/photocontest/redir.php';
						title='Modified Up';
