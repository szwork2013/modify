...
<div style="width:100%;height:31px;background-color:#455560;clear:both;text-align:left;"> 
        <div style="font-size:18px;font-weight:normal;padding-left:10px;padding-top:3px;color:white;float:left;font-family: 'Trebuchet MS', sans-serif;"> 
        Current Styles     
        </div> 
</div>

<p style="font-family: 'Trebuchet MS', sans-serif;padding-left:5px;">Here at Modify Watches we work hard to make every one of our mods feel loved, respected, and appreciated.  To date we have named over 1,500 watch combos<sup>*</sup>, and here's everything in the current range.</p>
 
<p style="font-family: 'Trebuchet MS', sans-serif;padding-left:5px;">Like what you see?  Then head over and <a href='buymodify.php' style="color:#ff7f00;">build your own</a> collection on our site!  (Hint: you can click <b>add all</b> over there to get every single one of these beauties.)</p>
 
<p style="font-size:10px;style="font-family: 'Trebuchet MS', sans-serif;padding-left:5px;">* may not be entirely accurate.</p> 
 
<div style="background-color:#455560;width:520px;height:4800px;margin:0 auto;"> 
  <div style="background-color:#FFFFFF;width:480px;height:4800px;margin:0 auto;padding-left:12px;">
  <center>
<?php
...
$array = array(
	...
	array("face2strap4","Lejerk Jabandoner","<font face='Comic Sans MS'>This is definitely not a reference to a back-stabbing St. Vincent St. Mary graduate who left the Cleve</font>"),
