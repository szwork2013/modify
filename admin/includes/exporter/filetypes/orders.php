...
class ISC_ADMIN_EXPORTFILETYPE_ORDERS extends ISC_ADMIN_EXPORTFILETYPE
{
	...
	public function GetFields()
	{
		$fields = array(
			...
			"orderCouponDiscount"   => array("dbfield" => "coupon_discount", "format" => "number"),
			"orderCouponCode"   => array("dbfield" => "(SELECT ordcouponcode FROM [|PREFIX|]order_coupons WHERE ordcouporderid = o.orderid)"),
