	...
	<tr>
		<td>
			<ul id="tabnav">
                ...
                <li><a href="#" id="tab10" onclick="ShowTab(10)" class="HideOnDigitalProduct">{% lang 'Associations' %}</a></li>
		...
		<td>
						...
						<td>
							<div id="ProductType" class="Field" style="float:left">
								<div>
                                    ...
                                    <span style="display:{{ ProdType_0Hidden|safe }};" id="physicalTypes">
                                        <p style="padding-left:25px;">
                                            <span class="Required">*</span>&nbsp;{% lang 'PhysicalProductType' %}<br />
                                            <input style="margin-top:10px;" type="radio" name="physProdType" id="physProdTypeFace" value="1" {{ IsPhysProd_1|safe }} /> <label for="physProdTypeFace">{% lang 'PhysicalProductFace' %}</label><br />
                                            <input type="radio" name="physProdType" id="physProdTypeStrap" value="2" {{ IsPhysProd_2|safe }} /> <label for="physProdTypeStrap">{% lang 'PhysicalProductStrap' %}</label><br />
                                            <input disabled type="radio" name="physProdType" id="physProdTypeMod" value="3" {{ IsPhysProd_3|safe }} /> <label for="physProdTypeMod">{% lang 'PhysicalProductMod' %}</label><br />
                                            <input type="radio" name="physProdType" id="physProdTypeSet" value="4" {{ IsPhysProd_4|safe }} /> <label for="physProdTypeSet">{% lang 'PhysicalProductSet' %}</label><br />
                                            <input type="radio" name="physProdType" id="physProdTypeOther" value="5" {{ IsPhysProd_5|safe }} /> <label for="physProdTypeOther">{% lang 'PhysicalProductOther' %}</label>
                                        </p>
                                    </span>
								</div>
								<div>
                                ...
                                <div>
									<input {{ ProdType_5|safe }} id="ProductType_2" type="radio" name="prodtype" value="5" onclick="ToggleType(5)" /><label for="ProductType_5">{% lang 'SubscriptionProduct' %}</label>
								</div>
							</div>
			...
			<div id="div6" style="padding-top: 10px;">
				...
				<table width="100%" class="Panel">
                    ...
                    <tr>
						<td class="FieldLabel">
							&nbsp;&nbsp;&nbsp;{% lang 'ProductSubTitle' %}:
						</td>
						<td>
	                        <input type="text" id="prodSubTitle" name="prodSubTitle" class="Field400" value="{{ ProdSubTitle|safe }}">
							<img onmouseout="HideHelp('d18');" onmouseover="ShowHelp('templatelayout', '{% lang 'ProductSubTitle' %}', '{% lang 'ProductSubTitleHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
                    ...
                    <tr>
						...
						<td>
							<textarea id="prodQuote" name="prodQuote" class="Field400" rows="4">{{ ProdQuote|safe }}</textarea>
							<img onmouseout="HideHelp('d18');" onmouseover="ShowHelp('templatelayout', '{% lang 'ProductQuote' %}', '{% lang 'ProductQuoteHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
							<div style="display:none" id="d18"></div>
						</td>
					</tr>
                    <tr>
						<td class="FieldLabel">
							&nbsp;&nbsp;&nbsp;{% lang 'ProductQuoteAuthor' %}:
						</td>
						<td>
	                        <input type="text" id="prodQuoteAuthor" name="prodQuoteAuthor" class="Field400" value="{{ ProdQuoteAuthor|safe }}">
							<img onmouseout="HideHelp('d18');" onmouseover="ShowHelp('templatelayout', '{% lang 'ProductQuoteAuthor' %}', '{% lang 'ProductQuoteAuthorHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
							<div style="display:none" id="d18"></div>
						</td>
					</tr>
					<tr>
						...
						<table class="GridPanel productImagesTable" cellspacing="0">
							<tbody>
								<tr class="Heading3">
                                    ...
                                    <td class="productImageComponent"><span class="HelpText" onmouseout="HideQuickHelp(this)" onmouseover="ShowQuickHelp(this, '{% jslang 'UseAsComponent' %}', '{% jslang 'UseAsComponentHelpText' %}')">{% lang 'UseAsComponent' %}</span></td>
            ...
            <div id="div10" style="padding-top: 10px;">
				<div style="padding-bottom:5px">{% lang 'ProductAssociationsIntro' %}</div>
				  <table class="Panel" id="tabInventory">
					<tr>
					  <td class="Heading2" colspan=2>{% lang 'ProductAssociationOptions' %}</td>
					</tr>
					<tr>
						<td class="FieldLabel">
							&nbsp;&nbsp;&nbsp;{% lang 'ThisProduct' %}:
						...
						<td style="padding-bottom:10px">
							<input type="radio" name="useProdAssociation" id="useProdAssociationNo" value="0" {{ IsNoAssociation|safe }} /> <label for="useProdAssociationNo">{% lang 'ProductWillNotUseAssociation' %}</label><br />
							<input type="radio" name="useProdAssociation" id="useProdAssociationYes" value="1" {{ IsYesAssociation|safe }} /> <label for="useProdAssociationYes" id="AssociationLabel" style="color:{{ AssociationColor|safe }}">{% lang 'ProductWillUseAssociation' %}</label>
							<span style="display:{{ HideAssociationList|safe }};" id="associationList">
								<div id="usedforproddiv" style="padding-left:25px">
                                    <select size="12" name="products" id="ProductSelect" class="Field250" onchange="$('#ProductRemoveButton').attr('disabled', false);">
                                        {{ AssociationOptions|safe }}
                                    </select>
                                    <div class="Field250" style="text-align: left;">
                                        <div style="float: right;">
                                            <input type="button" value="{% lang 'AssociationRemoveSelected' %}" id="ProductRemoveButton" disabled="disabled" class="FormButton" style="width: 125px;" onclick="removeFromProductSelect('ProductSelect', 'prodids');" />
                                        </div>
                                        <input type="button" value="{% lang 'AssociationAddProduct' %}" class="FormButton" style="width: 125px;" onclick="openProductSelect('coupon', 'ProductSelect', 'prodids');" />
                                    <input type="hidden" name="prodids" id="prodids" class="Field250" value="{{ ProductIds|safe }}" />
                                </div>
                                <p>
                                    <span class="Required">*</span>&nbsp;{% lang 'ProductAssociationType' %}<br />
                                    <input type="radio" name="prodAssociationType" id="prodAssociationTypePseudo" value="0" {{ IsPseudoAssociation|safe }} /> <label for="prodAssociationTypePseudo">{% lang 'ProductAssociationTypePseudo' %}</label><br />
                                    <input type="radio" name="prodAssociationType" id="prodAssociationTypeInventory" value="1" {{ IsInventoryAssociation|safe }} /> <label for="prodAssociationTypeInventory">{% lang 'ProductAssociationTypeInventory' %}</label>
                                </p>
							</span>
						</td>
					</tr>
				...
				<div style="display:{{ HideVariationCombinationList|safe }}; margin-bottom:5px" class="GridContainer" id="variationCombinationsList">
					{{ AssociationCombinationList|safe }}
				</div>
			</div>
...
lang.ProductMinimumMaximumError = '{% jslang 'ProductMinimumMaximumError' %}';
lang.ProductAssociationError = '{% jslang 'ProductAssociationError' %}';
lang.ProductAssociationEmptyError = '{% jslang 'ProductAssociationEmptyError' %}';
//]]></script>
